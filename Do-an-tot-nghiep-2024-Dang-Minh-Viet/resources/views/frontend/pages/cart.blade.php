...
@section('title','VietShop || Cart Page')
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Mã giảm<span>{{number_format(Session::get('coupon')['value'])}} VNĐ</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Bạn phải trả<span>{{number_format($total_amount)}} VNĐ</span></li>
										@else
											<li class="last" id="order_total_price">Bạn phải trả<span>{{number_format($total_amount)}} VNĐ</span></li>
										@endif
									</ul>
