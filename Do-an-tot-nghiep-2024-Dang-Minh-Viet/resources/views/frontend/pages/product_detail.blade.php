									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @php 
												$price_vnd = $product_detail->price ; 
												$after_discount_vnd = $price_vnd - ($product_detail->price * $product_detail->discount / 100);
                                                @endphp
												<p class="price"><span class="discount">{{number_format($after_discount_vnd, 0, ',', '.') }} VNĐ</span><s>{{number_format($price_vnd, 0, ',', '.') }} VNĐ</s> </p>
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            @php 
											    ...
											    $after_discount_vnd = $price_vnd - ($data->discount * $price_vnd / 100);
                                            @endphp
                                            <span class="old">{{number_format($price_vnd, 0, ',', '.') }} VNĐ</span>
                                            <span>{{number_format($after_discount_vnd, 0, ',', '.') }} VNĐ</span>
                                        </div>
