...
@section('main-content')
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4>Liên lạc</h4>
									<h3>Viết cho chúng tôi một tin nhắn @auth @else<span style="font-size:12px;" class="text-danger">[Bạn cần Đăng nhập trước!]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input id="phone" name="phone" type="number" placeholder="Nhập SĐT">
											</div>	
										</div>
										<div class="col-12">
	...
	<div class="map-section">
		<div id="myMap">
		    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d14130.857353934944!2d105.8542!3d21.0285!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1svi!2s!4v1595323330171!5m2!1svi!2s" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		</div>
	</div>
	<!--/ End Map Section -->
